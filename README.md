...
# Work with StackSpot AI
aider --model stackspot-ai-code --api-key stackspot=your-key-goes-here
```
<!--[[[end]]]-->
...
- Aider works best with Claude 3.5 Sonnet, DeepSeek V3, o1 & GPT-4o and can [connect to almost any LLM](https://aider.chat/docs/llms.html), including StackSpot AI.
